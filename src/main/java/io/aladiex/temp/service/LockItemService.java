...
/**
 * Service Implementation for managing {@link LockItem}.
 */
@Service
@Transactional
public class LockItemService {
    ...
    public LockItemService(LockItemRepository lockItemRepository) {
     ...
     */
    public LockItem save(LockItem lockItem) {
        log.debug("Request to save Order : {}", lockItem);
        return lockItemRepository.save(lockItem);
    }
     ...
     * @return the persisted entity.
     */
    public BigDecimal getLockedAmountAtRound(int roundId, long assetId) {
        return lockItemRepository.findByAssetIdAndRound(assetId, roundId).get().getAmount();
    }
     ...
     */
    public BigDecimal getLockedAmount(long assetId) {
        return lockItemRepository.getLockedAmountByAssetId(assetId).get();
    }
    ...
    public Page<LockItem> findAll(Pageable pageable) {
        log.debug("Request to get all LockItems");
        return lockItemRepository.findAll(pageable);
     ...
     */
    @Transactional(readOnly = true)
    public LockItem findOne(Long id) {
        log.debug("Request to get Order : {}", id);
        return lockItemRepository.findById(id).get();
    }
    ...
    public void delete(Long id) {
        ...
        lockItemRepository.deleteById(id);
    }
}
